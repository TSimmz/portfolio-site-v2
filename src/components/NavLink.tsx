...
const NavLink: FC<NavLinkProps> = ({
  ...
  return (
    <motion.a
      ...
      className={`relative ml-0 flex touch-auto flex-row items-center space-x-0 rounded-md px-2 py-1 align-middle text-base text-dark-base transition-colors duration-300 ease-linear sm:text-sm min-[710px]:px-3 min-[800px]:px-4 lg:px-5 ${
        isActive.current
